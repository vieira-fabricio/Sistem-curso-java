...
import br.com.springboot.springboot.dto.NewUser;
...
public class UserService {
	...
	public void salvar(NewUser newUser) {
		User novoUsuario = new User();
		novoUsuario.setName(newUser.getName());
		novoUsuario.setUserName(newUser.getUserName());
